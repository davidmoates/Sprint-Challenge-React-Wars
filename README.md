...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
  ...
  React is a JS Library that helps you write components faster

- [ ] What does it mean to _think_ in react?

  Thinking more like building small pieced that make one big thing. Voltron

- [ ] Describe state.

  State is like Memory.

- [ ] Describe props.

  Props are pieces of data the go from parent to child
